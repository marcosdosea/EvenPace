...
namespace Service
{
    public class CupomService : ICupomService
    {
        ...
        public async Task<int> Create(Cupom cupom)
        {
            cupom.Id = 0;
            _context.Add(cupom);
        ...
        public async Task Edit(Cupom cupom)
        {
        ...
        public async Task<IEnumerable<Cupom>> GetAll()
        {
            return await _context.Cupoms
                .AsNoTracking()
                .ToListAsync();
        }
        ...
        public async Task<IEnumerable<Cupom>> GetByName(string nome)
        {
            return await _context.Cupoms.Where(c => c.Nome.Contains(nome))
                .AsNoTracking()
                .ToListAsync();
        }
    }
