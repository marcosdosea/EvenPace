...
public class UntitledTest {
  ...
  public void untitled() {
        ...
        driver.FindElement(By.CssSelector(".opcoes:nth-child(8) .checkmark")).Click();
        driver.FindElement(By.CssSelector(".opcoes:nth-child(10) .checkmark")).Click();
